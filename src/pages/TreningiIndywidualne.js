...
const TreningiIndywidualnePage = ({data}) => {
return (
    <>
    <Wrapper>
    <h1 className={styles.Maintitle}>{data.datoCmsTreningiindywidualne.title}</h1>
        <div>
        {data.datoCmsTreningiindywidualne.content.map(item => {
...
export default TreningiIndywidualnePage
